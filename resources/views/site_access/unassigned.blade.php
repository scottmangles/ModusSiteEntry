          ...
          <table class="min-w-full divide-y divide-gray-300">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pr-6">Name</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-500 sm:pl-6">{{ $user->name }}</td>
