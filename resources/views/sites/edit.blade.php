        ...
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
          <div>
            ...
            <div class="mt-6 space-y-6 sm:mt-5 sm:space-y-5">
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <x-input type="text" name="name" value="{{ old('name') ?? $site->name }}"></x-input>
                    </div>
                </div>
            </div>
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                  <select name="site_manager" class="block w-full max-w-lg border-gray-300 rounded-md shadow-sm focus:ring-[#173a68] focus:border-[#173a68] sm:max-w-xs sm:text-sm">
                    @isset($site->site_manager)
                        <option value="{{ old('site_manager') ?? $site->site_manager }}" selected>{{ $site->siteManager->name }}</option>  
                    @endisset
            ...
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <x-input type="time" name="open_at" min="00:01" max="12:00" value="{{ old('open_at') ?? $site->open_at }}" required></x-input>
            </div>
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
