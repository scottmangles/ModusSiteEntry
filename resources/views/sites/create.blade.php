            ...
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                  <select name="site_manager" class="block w-full max-w-lg border-gray-300 rounded-md shadow-sm focus:ring-[#173a68] focus:border-[#173a68] sm:max-w-xs sm:text-sm">
                    ...
                    <option value="enter code to display site managers">enter code to display site managers</option>
                  </select>
                </div>
            </div>
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                <x-label> Site opens at </x-label>
                <x-input type="time" name="opens_at" min="00:01" max="12:00" required></x-input>
            </div>
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                <x-label> Site closes at </x-label>
                <x-input type="time" name="closes_at" min="12:01" max="00:00" required></x-input>
            </div>
